...
public class UI_EHall_Controller : MonoBehaviour
{
    #region SingleTon
    public static UI_EHall_Controller instance;
    ...
    public TextMeshProUGUI RecieveObjContet; 
    [Header("Panel")]
    ...
    public void ShowReceiveObjectPanel(bool state , string content)
    {
        ReceiveObject.gameObject.SetActive(state);
        RecieveObjContet.text = content;
    }
